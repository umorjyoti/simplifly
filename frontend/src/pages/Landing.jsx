          ...
          <div className="text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <button
                ...
                className="group relative bg-gradient-to-r from-primary-600 to-purple-600 text-white px-10 py-5 rounded-xl font-bold text-lg hover:from-primary-700 hover:to-purple-700 transition-all shadow-2xl hover:shadow-primary-500/50 hover:scale-105 flex items-center gap-3 min-w-[300px] justify-center transform"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary-400 to-purple-400 rounded-xl blur opacity-75 group-hover:opacity-100 transition"></div>
